  ...
  (color-theme-install
   '(color-theme-blackboard
     ((background-color . "#282828")
      ...
      (mouse-color . "sienna1"))
     (default ((t (:background "#282828" :foreground "#F8F8F8"))))
     (blue ((t (:foreground "blue"))))
     (bold ((t (:bold t))))
     (bold-italic ((t (:bold t))))
     (border-glyph ((t (nil))))
     (buffers-tab ((t (:background "#282828" :foreground "#F8F8F8"))))
...
(defun color-theme-idle-fingers ()
  ...
  (color-theme-install
    ...
    (modeline ((t (:background "#282828" :foreground "#00000"))))
	  (mode-line ((t (:background "#282828" :foreground "#00000"))))
    (modeline-mousable ((t (:background "#282828" :foreground "#00000"))))
